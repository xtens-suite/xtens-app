 ...
 */
/* jshint node: true */
/* globals _, sails, Project, ProjectService, GroupService, BiobankService, TokenService, Group, OperatorService */
...
const coroutines = {
    ...
    edit: BluebirdPromise.coroutine(function* (req, res) {
        ...
        const payload = yield BluebirdPromise.props({
            ...
            operators: OperatorService.getOperatorsAdminByProject(params.id),
        ...
        if (payload.project && payload.project.owner !== operator.id && !operator.isWheel) {
            throw new PrivilegesError(`Authenticated user has not edit project ${params.id}`);
        }
