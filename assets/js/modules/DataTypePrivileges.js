...
(function (xtens, DataTypePrivileges) {
    // dependencies
    DataTypePrivileges.Views = {};
    var i18n = require('./i18n.js').en;
    var DataTypePrivilegeLevels = require('./XtensConstants.js').DataTypePrivilegeLevels;
    ...
    DataTypePrivileges.Views.Edit = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.template = require("./../../templates/datatypeprivileges-edit.ejs");
            this.render();
        },
                ...
                success: function (dataTypePrivileges) {
                    ...
                    $('.modal-cnt').one('hidden.bs.modal', function (e) {
                        ...
                        if (xtens.session.get("isWheel")) {
                            xtens.router.navigate('datatypeprivileges?groupId=' + dataTypePrivileges.get("group"), { trigger: true });
                        } else {
                ...
                that.$modal.one('hidden.bs.modal', function (e) {
                    ...
                    that.model.destroy({
                        success: function (model, res) {
                            ...
                            that.$modal.one('hidden.bs.modal', function (e) {
                                modal.remove();
                                xtens.router.navigate('datatypeprivileges?groupId=' + groupId, { trigger: true });
                            });
                        },
                        error: function (model, res) {
                            xtens.error(res);
    ...
    DataTypePrivileges.Views.List = Backbone.View.extend({
        ...
        initialize: function (options) {
            $("#main").html(this.el);
            this.template = require("./../../templates/datatypeprivileges-list.ejs");
...
}(xtens, require('./DataTypePrivileges.js')));
