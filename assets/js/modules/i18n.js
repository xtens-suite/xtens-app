(function (xtens, i18n) {
    var en = {
        ...
        "query-selector": "My Queries",
        "load": "Load",
        "query-name": "Query Name",
        "reset": "Reset",
        "name-yet-present": "Name already present in your queries. Please Insert a different name to save a new query. Otherwise the existing query will be overwrited.",
